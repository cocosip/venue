...
func NewWithDefaults() *viper.Viper {
	...
	source.SetDefault("sourceCleanup.enabled", defaults.SourceCleanup.Enabled)
	source.SetDefault("sourceCleanup.databasePath", defaults.SourceCleanup.DatabasePath)
	source.SetDefault("sourceCleanup.pollingInterval", defaults.SourceCleanup.PollingInterval)
	source.SetDefault("sourceCleanup.maxConcurrentActions", defaults.SourceCleanup.MaxConcurrentActions)
	source.SetDefault("sourceCleanup.maxActiveJobs", defaults.SourceCleanup.MaxActiveJobs)
	source.SetDefault("sourceCleanup.terminalJobRetentionPeriod", defaults.SourceCleanup.TerminalJobRetentionPeriod)
	source.SetDefault("sourceCleanup.importReservationTimeout", defaults.SourceCleanup.ImportReservationTimeout)
	source.SetDefault("sourceCleanup.enableDatabaseOptimization", defaults.SourceCleanup.EnableDatabaseOptimization)
	source.SetDefault("sourceCleanup.databaseOptimizationInterval", defaults.SourceCleanup.DatabaseOptimizationInterval)
	source.SetDefault("sourceCleanup.terminalPruneBatchSize", defaults.SourceCleanup.TerminalPruneBatchSize)
